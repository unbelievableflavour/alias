namespace Application.Constants {
    public const string APP_NAME = "Alias";
    public const string EXEC_NAME = "Alias";
    public const string DESKTOP_NAME = "com.github.bartzaalberg.alias.desktop";
    ...
    public const Gdk.RGBA BRAND_COLOR = {0.114, 0.710, 1.000, 1.0};
}
